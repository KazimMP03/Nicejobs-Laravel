...
$(window).on('load resize', function () {
    ...
    // Show/Hide Password Signinup
    function toggleSenha() {
    const input = document.getElementById('senha');
    const icon = document.getElementById('toggleIconSenha');
...
function toggleConfirmaSenha() {
    const input = document.getElementById('confirmaSenha');
    const icon = document.getElementById('toggleIconConfirma');
