...
@section('content')
    ...
    <div class="w-100 d-flex justify-content-between align-items-start mb-4 px-1">
        ...
        {{-- Removido botão “Atualizar” do cabeçalho --}}
    </div>
    ...
    <div class="w-100 d-flex flex-column align-items-center py-5">
        ...
        >
            <div class="address-container">
                ...
                >
                    ...
                    <div class="form-floating form-group mb-4">
                        <input
                            ...
                            name="logradouro"
                            value="{{ old('logradouro', $address->logradouro) }}"
                    ...
                    <div class="form-floating form-group mb-4">
                        <input
                            ...
                            name="numero"
                            value="{{ old('numero', $address->numero) }}"
                            placeholder="Número"
                            required
                        >
                    ...
                    <div class="form-floating form-group mb-4">
                        <input
                            ...
                            name="bairro"
                            value="{{ old('bairro', $address->bairro) }}"
                            placeholder="Bairro"
                            required
                        >
                    ...
                    <div class="form-floating form-group mb-4">
                        <input
                            ...
                            name="cidade"
                            value="{{ old('cidade', $address->cidade) }}"
                            placeholder="Cidade"
                            required
                        >
                    ...
                    <div class="form-floating mb-4">
                        ...
                        >
                            ...
                            @foreach ([
                                ...
                                <option
                                    value="{{ $sigla }}"
                                    {{ old('estado', $address->estado) == $sigla ? 'selected' : '' }}
                                >
                                    {{ $estadoNome }}
                                </option>
                            @endforeach
                ...
                {{-- Botões centralizados com 50px de espaçamento --}}
