...
<body>
    <div class="register-container">
        <div class="register-header text-center mb-4">
            <img src="{{ asset('images/logo.png') }}" alt="NiceJobs" class="logo mb-2">
        ...
        <div class="register-body">
            ...
            <form method="POST" action="{{ route('register.provider') }}" enctype="multipart/form-data" id="providerForm">
                @csrf
                <!-- Status padrão -->
                    ...
                    <div class="row g-3">
                        ...
                        <div class="col-md-6">
                            ...
                            <select class="form-select @error('user_type') is-invalid @enderror" id="user_type" name="user_type" required>
                                <option value="" disabled {{ old('user_type') ? '' : 'selected' }}>Selecione...</option>
                        ...
                        <div class="col-md-6">
                            ...
                            <input type="text" class="form-control @error('tax_id') is-invalid @enderror" id="tax_id" name="tax_id" value="{{ old('tax_id') }}" placeholder="Selecione o tipo de pessoa primeiro" required>
                            @error('tax_id')<div class="invalid-feedback">{{ $message }}</div>@enderror
                        </div>

                        <div class="col-md-6" id="birth_date_field" style="{{ old('user_type') != 'PF' ? 'display: none;' : '' }}">
                        ...
                        <div class="col-md-6" id="foundation_date_field" style="{{ old('user_type') != 'PJ' ? 'display: none;' : '' }}">
                ...
                <div class="form-section" id="section2" style="display: none;">
                    ...
                    <div class="row g-3">
                        <div class="col-12">
                            ...
                            <textarea class="form-control @error('provider_description') is-invalid @enderror" id="provider_description" name="provider_description" rows="3" required>{{ old('provider_description') }}</textarea>
                        ...
                        <div class="col-md-6">
                            ...
                            <input type="number" class="form-control @error('work_radius') is-invalid @enderror" id="work_radius" name="work_radius" value="{{ old('work_radius') ?? 10 }}" min="1" required>
                        ...
                        <div class="col-12">
                            ...
                            <div class="form-check">
                                <input class="form-check-input @error('availability') is-invalid @enderror" type="radio" name="availability" id="availability_weekdays" value="weekdays" {{ old('availability', 'weekdays') == 'weekdays' ? 'checked' : '' }}>
                                <label class="form-check-label" for="availability_weekdays">Dias de semana</label>
                            </div>
                            <div class="form-check">
                                <input class="form-check-input @error('availability') is-invalid @enderror" type="radio" name="availability" id="availability_weekends" value="weekends" {{ old('availability') == 'weekends' ? 'checked' : '' }}>
                                <label class="form-check-label" for="availability_weekends">Finais de semana</label>
                            </div>
                            <div class="form-check">
                                <input class="form-check-input @error('availability') is-invalid @enderror" type="radio" name="availability" id="availability_both" value="both" {{ old('availability') == 'both' ? 'checked' : '' }}>
                    ...
                    <div class="d-flex justify-content-between mt-4">
                        <button type="button" class="btn btn-outline-secondary prev-section" data-prev="section1">Voltar</button>
                ...
                <div class="form-section" id="section3" style="display: none;">
                    ...
                    <div class="form-check mb-4">
                        ...
                        <label class="form-check-label" for="terms">
                            Li e aceito os <a href="#" data-bs-toggle="modal" data-bs-target="#termsModal">Termos de Serviço</a> e <a href="#">Política de Privacidade</a>
                        </label>
                        @error('terms')<div class="invalid-feedback">{{ $message }}</div>@enderror
                    </div>

                    <div class="d-flex justify-content-between">
                        <button type="button" class="btn btn-outline-secondary prev-section" data-prev="section2">Voltar</button>
