...
<head>
    <meta charset="utf-8">
    <title>NiceJobs - Cadastro de Cliente</title>
    ...
    <div class="page-wrapper hidden-until-loaded">
        <div class="register-container">
            <div class="d-flex align-items-center justify-content-between my-4 mx-4">
                ...
                <h3 class="mb-0 fw-bold text-secondary">Cadastro de Cliente</h3>
            </div>
            ...
            <div class="register-body">
                ...
                <form method="POST" action="{{ route('register.custom-user.post') }}" enctype="multipart/form-data"
                    id="clientForm">
                    @csrf
                    ...
                    <div class="form-section" id="section1">
                        <h4 class="mb-4" style="color: #009CFF;"><i class="fas fa-user me-2"
                                style="color: #009CFF;"></i> Dados Pessoais</h4>
                    ...
                    <div class="form-section" id="section2" style="display: none;">
                        <h4 class="mb-4" style="color: #009CFF;"><i class="fas fa-check-circle me-2"
                                style="color: #009CFF;"></i> Confirmação</h4>

                        <div class="card mb-4">
                            <div class="card-body">
                                <h5 class="card-title" style="font-weight: bold; font-size: 1.5rem; color: #6c757d;">
                                    Revise Seus Dados
                                </h5>
                                <div class="mt-3">
                                    <h6 style="text-decoration: underline; color: #009CFF;">Dados Pessoais</h6>
                                    <p id="review-name" class="text-muted" style="font-size: 14px; margin-bottom: 4px;">
                                    </p>
