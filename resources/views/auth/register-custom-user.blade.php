...
<head>
    ...
    <!-- Link para o css da tela de registro de CustomUser de serviço -->
...
<body>
    <div class="register-container">
        <div class="register-header text-center mb-4">
            ...
            <p class="mb-0">Informe seus dados para usar a plataforma</p>
        </div>

        <div class="register-body">
            <div class="step-indicator mb-4">
                <div class="step active"><div class="step-number">1</div><div class="step-title">Dados Pessoais</div></div>
                <div class="step"><div class="step-number">2</div><div class="step-title">Confirmação</div></div>
            </div>

            <form method="POST" action="{{ route('register.custom-user.post') }}" enctype="multipart/form-data" id="clientForm">
                @csrf
